...
const alignKeywords = ['start', 'end', 'left', 'right', 'center', 'justify', 'match-parent'];
...
const lineStyle = ['none', 'hidden', 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inset', 'outset'];
...
const validData = {
  ...
  columns: [], // 146
  content: ['open-quote', 'close-quote', 'no-open-quote', 'no-close-quote', 'normal', 'none'], // 147
  ...
  fontVariationSettings: ['normal', '"wght"', '"wdth"', '"slnt"', '"ital"', '"opsz"'], // 185
  grid: ['none'], // 186
  gridArea: ['auto'], //187
  ...
  imageRendering: ['auto', 'smooth', 'high-quality', 'crisp-edges', 'pixelated'], // 206
  ...
  rubyPosition: ['over', 'under', 'alternate', 'alternate over', 'alternate under', 'inter-character'], // 302
  rx: ['auto'], // 303
  ry: ['auto'], // 304
  scale: ['none'], // 305
  ...
  textDecorationLine: ['none', 'underline', 'overline', 'line-through', 'blink'], // 354
  ...
  textEmphasis: ['none', 'filled', 'open', 'dot', 'circle', 'double-circle', 'triangle', 'sesame'], // 358
  ...
  textOrientation: ['mixed', 'upright', 'sideways', 'sideways-right', 'use-glyph-orientation'], // 364
  textOverflow: ['clip', 'ellipsis'], // 365
  textRendering: ['auto', 'optimizeSpeed', 'optimizeLegibility', 'geometricPrecision'], // 366
  textShadow: [], // 367
  textTransform: ['none', 'captalize', 'uppercase', 'lowercase', 'full-width', 'full-size-kana', 'math-auto'], // 368
  textUnderlineOffset: ['auto'], // 369
  textUnderlinePosition: ['auto', 'under', 'left', 'right', 'under left', 'left under', 'under right', 'right under'], // 370
  textWrap: ['auto', 'wrap', 'nowrap', 'balance', 'pretty', 'stable', 'avoid-orphans'], // 371
  textWrapMode: ['wrap', 'nowrap'], // 372
  textWrapStyle: ['auto', 'balance', 'stable', 'pretty', 'avoid-orphans'], // 373
  touchAction: ['auto', 'none'], // 374
  transform: ['none'], // 375
  transformBox: ['content-box', 'border-box', 'fill-box', 'stroke-box', 'view-box'], // 376
  transformOrigin: [], // 377
  ...
  translate: ['none'], // 385
  unicodeBibi: ['normal', 'embed', 'isolate', 'bibi-override', 'isolate-override', 'plaintext'], // 386
  userSelect: ['none', 'auto', 'text', 'all'], // 387
  vectorEffect: ['none', 'non-scaling-stroke', 'non-scaling-size', 'non-rotation', 'fixed-position'], // 388
  verticalAlign: ['baseline', 'sub', 'super', 'text-top', 'text-bottom', 'middle', 'top', 'bottom'], // 389
  visibility: ['visible', 'hideen', 'collapse'], // 390
  whiteSpace: ['normal', 'pre', 'nowrap', 'pre-wrap', 'break-spaces', 'pre-line'], // 391
  whiteSpaceCollapse: ['collapse', 'discard', 'preserve', 'preserve-breaks', 'preserve-spaces', 'break-spaces'], // 392
  widows: [], // 393
  willChange: [], // 394
  wordBreak: ['normal', 'keep-all', 'break-all', 'break-word', 'auto-phrase'], // 395
  writingMode: ['horizontal-tb', 'vertical-rl', 'vertical-lr', 'sideways-rl', 'sideways-lr'], // 396
